...
export function useInventories() {
  ...
  const fetchInventories = useCallback(async () => {
    ...
    setError('')
    try {
      const res = await productsApi.listInventories()
...
export function useCreateInventory() {
  ...
  const create = useCallback(async (data: CreateInventoryRequest) => {
    ...
    setError('')
    try {
      const res = await productsApi.createInventory(data)
...
export function useUpdateInventory() {
  ...
  const update = useCallback(async (id: string, data: UpdateInventoryRequest) => {
    ...
    setError('')
    try {
      const res = await productsApi.updateInventory(id, data)
      return res.inventory
    } catch (e) {
...
export function useItems(inventoryId: string) {
  ...
  const fetchItems = useCallback(async () => {
    ...
    setError('')
    try {
      const res = await productsApi.listItems(inventoryId)
      setItems(res.items)
    } catch (e) {
...
export function useCreateItem() {
  ...
  const create = useCallback(async (inventoryId: string, data: CreateInventoryItemRequest) => {
    ...
    setError('')
    try {
      const res = await productsApi.createItem(inventoryId, data)
      return res.item
    } catch (e) {
...
export function useUpdateItem() {
  ...
  const update = useCallback(async (inventoryId: string, itemId: string, data: UpdateInventoryItemRequest) => {
    ...
    setError('')
    try {
      const res = await productsApi.updateItem(inventoryId, itemId, data)
      return res.item
    } catch (e) {
...
export function useDeleteItem() {
  ...
  const remove = useCallback(async (inventoryId: string, itemId: string) => {
    ...
    setError('')
    try {
      await productsApi.deleteItem(inventoryId, itemId)
      return true
    } catch (e) {
